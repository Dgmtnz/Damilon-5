...
public class PantallaPuertoEspacial extends Pantalla{
    ...
    public void mostrarOpciones() {
        System.out.println(" Te encuentras en la base Damilon5, con tu nave cargada y lista para despegar. Con " + Main.getJugador().dinero +"$ en tu bolsillo y provisiones para un mes, las posibilidades son infinitas. Pero, ¿cuál será tu próximo movimiento?");
