...
public class PantallaBatallaHanPilladoALaBanda extends Pantalla {

    Enemigo maton1 = new Enemigo("Conductor Chetado del convoy", Main.getJugador().vida/2, Main.getJugador().nivel/2, 2, 10);
    Enemigo maton2 = new Enemigo("Cristobal dueño de los cristales", Main.getJugador().vida, Main.getJugador().nivel/3, 0, 5);
    ...
    public void mostrarOpciones() {
        ...
        if (Main.getJugador().vida <= 0) {
            ...
            System.out.println("Has vencido a los matones del convoy." + " Has ganado 600 puntos de experiencia y 4000 de dinero.");

            Main.getJugador().dinero += 4000;
            Main.getJugador().experiencia += 600;
        
        
        Juego.pantallaActual = new PantallaBatallaHanPilladoALaBanda2();
        try {
            Thread.sleep(3000);
        } catch (InterruptedException e) {
            e.printStackTrace();
        ...
        maton1 = new Enemigo("Cyborg personal del banco", Main.getJugador().vida/2, Main.getJugador().nivel/2, 2, 10);
        maton2 = new Enemigo("Cristobal dueño del Oracle", Main.getJugador().vida, Main.getJugador().nivel/3, 0, 5);
