...
public class PantallaMinijuegoRobarCristales extends Pantalla {
    ...
    public void mostrarOpciones() {
        ...
        while (!haFallado && codigoSecreto.length() < LIMITE_SECUENCIA) {
            ...
            if (respuesta.equals(codigoSecreto)) {
                ...
                System.out.println("La alarma ha saltado, todos los miembros del convoy se alertan y tambien llaman a la policía");
        ...
        if (!haFallado) {
            ...
            System.out.println("Os habeis llevado un buen botin, Dinero +15000");
